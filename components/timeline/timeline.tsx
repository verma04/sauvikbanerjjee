...
const data = [
  {
    title: "Growing up",
    img1: "/growing-up-3.jpg",
    img2: "/timeline-growing.png",
    img3: "/growing-up-1.jpg",
    img4: "/growing-up-2.jpg",
  ...
  {
    title: "India Story",
    img1: "/sauvik-dada.jpg",
    img2: "/story-2.jpg",
    img3: "/story-3.jpg",
    img4: "/india-story-4.jpg",
  ...
  return (
    ...
    >
      <Center
        ...
        backgroundImage={[
          "/timeline-background.png",
          "/timeline-background.png",
          "/timeline-background-image.png",
          "/timeline-background-image.png",
        ]}
      >
        <Box
