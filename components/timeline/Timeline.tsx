...
const Timeline = () => {
  ...
  return (
    <ReactScrollWheelHandler rightHandler={up} upHandler={up} leftHandler={down} downHandler={down}  >
      <Center
        overflowX="hidden"
        width={"100%"}
        height={"100svh"}
        ...
        backgroundImage={["/timelineBackground.png", "/timelineBackground.png", "/timelineBackgroundImage.png", "/timelineBackgroundImage.png"]}
          ...
          >
            {data.map((set, index) => (
              ...
              >
                ...
                <Heading cursor={"pointer"} display={["none", "none", "flex", "flex"]} width={"10rem"} fontSize={"1.5rem"} color={index === count ? "#F96E42" : "white"} left="4rem" top="10%" position={"absolute"} >{set.title}</Heading>
              </Box>
            ))}
          </Box>
