...
import ContactNow from "./contact-now";
    ...
    <>
      <VStack
        ...
        bgImage={[
          ...
          "/footer-background.png",
          "/footer-background-desktop.png",
          "/footer-background-desktop.png",
        ]}
        height={["40svh", "40svh", "40vh", "40vh"]}
        width="100%"
      >
        <Center
        ...
        >
          <Center width={"100%"} height={["60%", "60%", "80%", "80%"]}>
            <Center
              ...
              backgroundPosition="center"
              backgroundSize={"cover"}
              backgroundImage={"/gradiend-frame.png"}
              width={"25%"}
              height="100%"
            >
              <a
        ...
        <Center width={"100%"} height="30%" flexDirection={"column"}>
          <Text
            fontSize={"0.9rem"}
            width={"99%"}
            textAlign={"center"}
